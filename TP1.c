...
void resultado_personaje(int puntos1,int puntos2,int multiplicador,int hora_llegada,int minuto_llegada){
...
int main() {
  ...
  resultado_personaje(puntos_pregunta_1, puntos_pregunta_2, multiplicador, hora_llegada, minuto_llegada);
  return 0;
}
